...
![](assets/image-20210721185923635.png)
...
![](assets/image-20210721185303106.png)
...
![](assets/image-20210404200055449.png)

选择选择和自己**系统位数**相对应的版本点击右边的`Download`，此时会进到另一个页面，同样在接近页面底部的地方找到如下图所示的位置：

![image-20220831124719103](assets\image-20220831124719103.png)
...
![](assets/1556823-20181220220242472-524708778.png)

点击`环境变量`

![](assets/1556823-20181220220359609-736422950.png)

在`系统变量`中新建MYSQL_HOME

![](assets/image-20201109140222488.png)

在`系统变量`中找到并**双击**`Path`

![](assets/1556823-20181220220551145-1198958872.png)

点击`新建`

![](assets/image-20201109135248104.png)
...
* SQL 语句可以单行或多行书写，以分号结尾。
  ...
  ![](assets/image-20210721215223872.png) 
...
* MySQL 数据库的 SQL 语句不区分大小写，关键字建议使用大写。
  ...
  ![](assets/image-20210721215328410.png)

* 注释

  * 单行注释: -- 注释内容 或 #注释内容(MySQL 特有) 

    ![](assets/image-20210721215517293.png) 

    ![](assets/image-20210721215556885.png) 
...
* DDL(Data Definition Language) ： 数据定义语言，用来定义数据库对象：数据库，表，列等
  ...
  ![](assets/image-20210721220032047.png)

* DML(Data Manipulation Language) 数据操作语言，用来对数据库中表的数据进行增删改

  DML简单理解就对表中数据进行增删改

  ![](assets/image-20210721220132919.png)
...
![](assets/image-20210721223450755.png)

而在创建数据库的时候，我并不知道db1数据库有没有创建，直接再次创建名为db1的数据库就会出现错误。

![](assets/image-20210721223745490.png)
...
![](assets/image-20210721230824097.png)
...
![](assets/image-20210721235928346.png)

第二步：填写连接数据库必要的信息

![](assets/image-20210722000116080.png)

以上操作没有问题就会出现如下图所示界面：

![](assets/image-20210722000345349.png)

#### 6.3.2  操作

连接成功后就能看到如下图界面：

![](assets/image-20210722000521997.png)

* **修改表结构**

通过下图操作修改表结构：

![](assets/image-20210722000740661.png)

点击了设计表后即出现如下图所示界面，在图中红框中直接修改字段名，类型等信息：

![](assets/image-20210722000929075.png)

* **编写SQL语句并执行**

按照如下图所示进行操作即可书写SQL语句并执行sql语句。

![](assets/image-20210722001333817.png)
...
* 查询所有列的数据，列名的列表可以使用*替代
  ...
  ![](assets/image-20210722221534870.png)
...
![](assets/image-20210722194410628.png)
...
![](assets/image-20210722230330366.png)
