!
    function() {
        ...
        function p(e, t, r, i) {
            ...
            var a = e._hooks[t],
                s = function(t) {
                    var e = a[t];
                    if (t >= a.length) i(r);
                    else if ("function" == typeof e) if (2 === e.length) e(r,
                        function(e) {
                            r = e,
                                s(t + 1)
                        });
        ...
        var g = document.body.clientWidth <= 600,
            a = window.history && window.history.pushState && window.history.replaceState && !navigator.userAgent.match(/((iPod|iPhone|iPad).+\bOS\s+[1-4]\D|WebApps\/.+CFNetwork)/),
            n = {};
        function m(e, t) {
        ...
        function L(e) {
            ...
            function() {
                ...
                t = i ? 80 < (t = parseInt($.style.width || 0, 10) + i) ? 80 : t: Math.floor(n / r * 100),
                $.style.opacity = 1,
                $.style.width = 95 <= t ? "100%": t + "%",
            95 <= t && (clearTimeout(C), C = setTimeout(function(e) {
                    $.style.opacity = 0,
                        $.style.width = "0%"
                },
                200))
        ...
        function R(a, e, t) {
            ...
            for (var i in s.open("GET", a), t) l.call(t, i) && s.setRequestHeader(i, t[i]);
            return s.send(),
                {
                    then: function(r, i) {
                        if (void 0 === i && (i = h), e) {
                                ...
                                function(e) {
                                    ...
                                    if (400 <= t.status) i(t);
                                        ...
                                        var n = T[a] = {
                                            content: t.response,
                                            opt: {
                                                updatedAt: s.getResponseHeader("last-modified")
                                            }
                                        };
                                        r(n.content, n.opt)
                                    }
        ...
        var j = N(function(v, e) { !
            function() {
                ...
                y._label = /(?!\s*\])(?:\\[\[\]]|[^\[\]])+/,
                    ...
                    l.prototype.token = function(e, t) {
                        var n, r, i, a, s, o, l, c, u, h, p, d, g, f, m, v;
                        for (e = e.replace(/^ +$/gm, ""); e;) if ((i = this.rules.newline.exec(e)) && (e = e.substring(i[0].length), 1 < i[0].length && this.tokens.push({
                            type: "space"
                        ...
                        else if ((i = this.rules.nptable.exec(e)) && (o = {
                            type: "table",
                            ...
                            for (p = 0; p < o.cells.length; p++) o.cells[p] = w(o.cells[p], o.header.length);
                            this.tokens.push(o)
                            ...
                            for (e = e.substring(i[0].length), l = {
                                ...
                                loose: !1
                                     ...
                                     this.tokens.push(l), n = !(c = []), g = (i = i[0].match(this.rules.item)).length, p = 0; p < g; p++) h = (o = i[p]).length,
                            ~ (o = o.replace(/^ *([*+-]|\d+\.) */, "")).indexOf("\n ") && (h -= o.length, o = this.options.pedantic ? o.replace(/^ {1,4}/gm, "") : o.replace(new RegExp("^ {1," + h + "}", "gm"), "")),
                            p !== g - 1 && (s = y.bullet.exec(i[p + 1])[0], (1 < a.length ? 1 === s.length: 1 < s.length || this.options.smartLists && s !== a) && (e = i.slice(p + 1).join("\n") + e, p = g - 1)),
                                r = n || /\n\n(?!\s*$)/.test(o),
                            p !== g - 1 && (n = "\n" === o.charAt(o.length - 1), r = r || n),
                            r && (l.loose = !0),
                                v = void 0,
                            (m = /^\[[ xX]\] /.test(o)) && (v = " " !== o[1], o = o.replace(/^\[[ xX]\] +/, "")),
                                u = {
                        ...
                        this.tokens.links[d] || (this.tokens.links[d] = {
                        ...
                        else if ((i = this.rules.table.exec(e)) && (o = {
                            type: "table",
                            header: w(i[1].replace(/^ *| *\| *$/g, "")),
                            align: i[2].replace(/^ *|\| *$/g, "").split(/ *\| */),
                            cells: i[3] ? i[3].replace(/\n$/, "").split("\n") : []
                            ...
                            for (e = e.substring(i[0].length), p = 0; p < o.align.length; p++) / ^*-+:*$ / .test(o.align[p]) ? o.align[p] = "right": /^ *:-+: *$/.test(o.align[p]) ? o.align[p] = "center": /^ *:-+ *$/.test(o.align[p]) ? o.align[p] = "left": o.align[p] = null;
                            for (p = 0; p < o.cells.length; p++) o.cells[p] = w(o.cells[p].replace(/^ *\| *| *\| *$/g, ""), o.header.length);
                            this.tokens.push(o)
                ...
                function k(e, t) {
                    if (t) {
                        if (k.escapeTest.test(e)) return e.replace(k.escapeReplace,
                            function(e) {
                                return k.replacements[e]
                            })
                    } else if (k.escapeTestNoEncode.test(e)) return e.replace(k.escapeReplaceNoEncode,
                        function(e) {
                            return k.replacements[e]
                        });
                    return e
                ...
                function a(e, t, n) {
                    ...
                    t && !o.test(n) && (n = function(e, t) {
                        s[" " + e] || (/^[^:]+:\/*[^/] * $ / .test(e) ? s[" " + e] = e + "/": s[" " + e] = x(e, "/", !0));
                        return e = s[" " + e], "//" === t.slice(0, 2) ? e.replace(/:[\s\S]*/, ":") + t: "/" === t.charAt(0) ? e.replace(/(:\/*[^/] * )[\s\S] * /,"$1")+t:e+t}(t,n));try{n=encodeURI(n).replace(/ % 25 / g,
                        "%")
                    } catch(e) {
                        return null
                    }
                ...
                n._punctuation = "!\"#$%&'()*+,\\-./:;<=>?@\\[^_{|}~",
                    ...
                    n._escapes = /\\([!"#$%&'()*+,\-./: ; <= >?@\ [\]\\ ^ _` { |
            }~]) / g, n._scheme = /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/, n._email = /[a-zA-Z0-9.!#$%&'*+/ = ?^_` { |
            }~ - ] + (@)[a - zA - Z0 - 9]( ? :[a - zA - Z0 - 9 - ] {
                0,
                    61
            ...
            0,
                61
        } [a - zA - Z0 - 9]) ? ) + ( ? ![ - _]) / , n.autolink = e(n.autolink).replace("scheme", n._scheme).replace("email", n._email).getRegex(), n._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/, n.tag = e(n.tag).replace("comment", y._comment).replace("attribute", n._attribute).getRegex(), n._label = /(?:\[[^\[\]]*\]|\\.|`[^`]*`|[^\[\]\\`])*?/, n._href = /<(?:\\[<>]?|[^\s<>\\])*>|[^\s\x00-\x1f]*/, n._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/, n.link = e(n.link).replace("label", n._label).replace("href", n._href).replace("title", n._title).getRegex(), n.reflink = e(n.reflink).replace("label", n._label).getRegex(), n.normal = d({},
            n), n.pedantic = d({},
            n.normal, {
            ...
            }), n.gfm.url = e(n.gfm.url, "i").replace("email", n.gfm._extended_email).getRegex(), n.breaks = d({},
            n.gfm, {
            ...
            u.prototype.output = function(e) {
                for (var t, n, r, i, a, s, o = ""; e;) if (a = this.rules.escape.exec(e)) e = e.substring(a[0].length),
                    o += k(a[1]);
                else if (a = this.rules.tag.exec(e)) ! this.inLink && /^<a /i.test(a[0]) ? this.inLink = !0 : this.inLink && /^<\/a>/i.test(a[0]) && (this.inLink = !1),
                    ...
                    o += this.options.sanitize ? this.options.sanitizer ? this.options.sanitizer(a[0]) : k(a[0]) : a[0];
                else if (a = this.rules.link.exec(e)) {
                    var l = g(a[2], "()");
                    if ( - 1 < l) {
                        var c = 4 + a[1].length + l;
                        a[2] = a[2].substring(0, l),
                            a[0] = a[0].substring(0, c).trim(),
                            a[3] = ""
                    }
                    e = e.substring(a[0].length),
                        this.inLink = !0,
                        r = a[2],
                        i = this.options.pedantic ? (t = /^([^'"]*[^\s])\s+(['"])(.*)\2/.exec(r)) ? (r = t[1], t[3]) : "": a[3] ? a[3].slice(1, -1) : "",
                    ...
                    o += this.renderer.strong(this.output(a[4] || a[3] || a[2] || a[1]));
                else if (a = this.rules.em.exec(e)) e = e.substring(a[0].length),
                    o += this.renderer.em(this.output(a[6] || a[5] || a[4] || a[3] || a[2] || a[1]));
                else if (a = this.rules.code.exec(e)) e = e.substring(a[0].length),
                    o += this.renderer.codespan(k(a[2].trim(), !0));
                    ...
                    r = "@" === a[2] ? "mailto:" + (n = k(this.mangle(a[1]))) : n = k(a[1]),
                    o += this.renderer.link(r, null, n);
                else if (this.inLink || !(a = this.rules.url.exec(e))) {
                    if (a = this.rules.text.exec(e)) e = e.substring(a[0].length),
                        this.inRawBlock ? o += this.renderer.text(this.options.sanitize ? this.options.sanitizer ? this.options.sanitizer(a[0]) : k(a[0]) : a[0]) : o += this.renderer.text(k(this.smartypants(a[0])));
                    else if (e) throw new Error("Infinite loop on byte: " + e.charCodeAt(0))
                } else {
                    if ("@" === a[2]) r = "mailto:" + (n = k(a[0]));
                    else {
                        for (; s = a[0], a[0] = this.rules._backpedal.exec(a[0])[0], s !== a[0];);
                        n = k(a[0]),
                            r = "www." === a[1] ? "http://" + n: n
                    }
                    e = e.substring(a[0].length),
            ...
            c.prototype.parse = function(e) {
                this.inline = new u(e.links, this.options),
                    this.inlineText = new u(e.links, d({},
                        this.options, {
                            renderer: new i
                        })),
            ...
            t.prototype.slug = function(e) {
                var t = e.toLowerCase().trim().replace(/[\u2000-\u206F\u2E00-\u2E7F\\'!"#$%&()*+,./: ; <= >?@ [\] ^ ` { |
                    }~] / g,
                    "").replace(/\s/g, "-");
        ...
        function h() {}
        function d(e) {
            for (var t, n, r = arguments,
                     i = 1; i < arguments.length; i++) for (n in t = r[i]) Object.prototype.hasOwnProperty.call(t, n) && (e[n] = t[n]);
            return e
        }
        function w(e, t) {
            var n = e.replace(/\|/g,
        ...
        function m(e, n, r) {
            ...
            if (r || "function" == typeof n) {
                ...
                if (!s || s.length < 3) return o();
                if (delete n.highlight, !a) return o();
                for (; t < i.length; t++) !
                    function(n) {
                        "code" !== n.type ? --a || o() : s(n.text, n.lang,
                            function(e, t) {
                                return e ? o(e) : null == t || t === n.text ? --a || o() : (n.text = t, n.escaped = !0, void(--a || o()))
                            })
                    } (i[t])
            } else try {
                return f(n = n && d({},
        ...
        h.exec = h, m.options = m.setOptions = function(e) {
            return d(m.defaults, e),
                m
        },
    ...
    var c = function(c) {
        var u = /\blang(?:uage)?-([\w-]+)\b/i,
            ...
            T = {
                ...
                util: {
                    encode: function(e) {
                        return e instanceof R ? new R(e.type, T.util.encode(e.content), e.alias) : Array.isArray(e) ? e.map(T.util.encode) : e.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/\u00a0/g, " ")
                    },
                    type: function(e) {
                    ...
                    clone: function n(e, r) {
                        var i, t, a = T.util.type(e);
                        switch (r = r || {},
                            a) {
                            case "Object":
                                if (t = T.util.objId(e), r[t]) return r[t];
                                for (var s in i = {},
                                    r[t] = i, e) e.hasOwnProperty(s) && (i[s] = n(e[s], r));
                                return i;
                            case "Array":
                                return t = T.util.objId(e),
                                    r[t] ? r[t] : (i = [], r[t] = i, e.forEach(function(e, t) {
                                        i[t] = n(e, r)
                                    }), i);
                            default:
                                return e
                ...
                languages: {
                    ...
                    insertBefore: function(n, e, t, r) {
                        var i = (r = r || T.languages)[n],
                            a = {};
                        for (var s in i) if (i.hasOwnProperty(s)) {
                            if (s == e) for (var o in t) t.hasOwnProperty(o) && (a[o] = t[o]);
                            t.hasOwnProperty(s) || (a[s] = i[s])
                        }
                        var l = r[n];
                        return r[n] = a,
                            T.languages.DFS(T.languages,
                                function(e, t) {
                                    t === l && e != n && (this[e] = a)
                                }),
                            a
                    ...
                    DFS: function e(t, n, r, i) {
                        ...
                        for (var s in t) if (t.hasOwnProperty(s)) {
                            ...
                            var o = t[s],
                                l = T.util.type(o);
                            "Object" !== l || i[a(o)] ? "Array" !== l || i[a(o)] || (i[a(o)] = !0, e(o, n, s, i)) : (i[a(o)] = !0, e(o, n, null, i))
                        }
                    }
                },
                plugins: {},
                ...
                highlightAllUnder: function(e, t, n) {
                    ...
                    for (var i, a = e.querySelectorAll(r.selector), s = 0; i = a[s++];) T.highlightElement(i, !0 === t, r.callback)
                },
                highlightElement: function(e, t, n) {
                    for (var r, i = "none",
                             a = e; a && !u.test(a.className);) a = a.parentNode;
                    a && (i = (a.className.match(u) || [, "none"])[1].toLowerCase(), r = T.languages[i]),
                        e.className = e.className.replace(u, "").replace(/\s+/g, " ") + " language-" + i,
                    e.parentNode && (a = e.parentNode, /pre/i.test(a.nodeName) && (a.className = a.className.replace(u, "").replace(/\s+/g, " ") + " language-" + i));
                    function s(e) {
                        o.highlightedCode = e,
                            T.hooks.run("before-insert", o),
                            o.element.innerHTML = o.highlightedCode,
                            T.hooks.run("after-highlight", o),
                            T.hooks.run("complete", o),
                        n && n.call(o.element)
                    }
                    var o = {
                        element: e,
                    ...
                    if (T.hooks.run("before-sanity-check", o), o.code) if (T.hooks.run("before-highlight", o), o.grammar) if (t && c.Worker) {
                    ...
                    } else s(T.highlight(o.code, o.grammar, o.language));
                    else s(T.util.encode(o.code));
                    else T.hooks.run("complete", o)
                },
                highlight: function(e, t, n) {
                    ...
                    return T.hooks.run("before-tokenize", r),
                        r.tokens = T.tokenize(r.code, r.grammar),
                        T.hooks.run("after-tokenize", r),
                        R.stringify(T.util.encode(r.tokens), r.language)
                },
                matchGrammar: function(e, t, n, r, i, a, s) {
                    for (var o in n) if (n.hasOwnProperty(o) && n[o]) {
                        ...
                        for (var c = 0; c < l.length; ++c) {
                            ...
                            u = u.pattern || u;
                            for (var v = r,
                                     b = i; v < t.length; b += t[v].length, ++v) {
                                var y = t[v];
                                if (t.length > e.length) return;
                                if (! (y instanceof R)) {
                                    if (d && v != t.length - 1) {
                                        if (u.lastIndex = b, !(A = u.exec(e))) break;
                                        for (var k = A.index + (p ? A[1].length: 0), w = A.index + A[0].length, x = v, _ = b, S = t.length; x < S && (_ < w || !t[x].type && !t[x - 1].greedy); ++x)(_ += t[x].length) <= k && (++v, b = _);
                                    ...
                                    if (A) {
                                        p && (g = A[1] ? A[1].length: 0);
                                        w = (k = A.index + g) + (A = A[0].slice(g)).length;
                                        var C = y.slice(0, k),
                                            E = y.slice(w),
                                            F = [v, $];
                                        C && (++v, b += C.length, F.push(C));
                                        var L = new R(o, h ? T.tokenize(A, h) : A, f, A, d);
                                        if (F.push(L), E && F.push(E), Array.prototype.splice.apply(t, F), 1 != $ && T.matchGrammar(e, t, n, v, b, !0, o), a) break
                                    } else if (a) break
                                }
                            }
                        }
                ...
                tokenize: function(e, t) {
                    ...
                    return T.matchGrammar(e, n, t, 0, 0, !1),
                        n
                },
                hooks: {
                    all: {},
        ...
        if (c.Prism = T, R.stringify = function(e, t) {
            ...
            !c.document) return c.addEventListener && (T.disableWorkerMessageHandler || c.addEventListener("message",
            function(e) {
                var t = JSON.parse(e.data),
                    n = t.language,
                    r = t.code,
                    i = t.immediateClose;
                c.postMessage(T.highlight(r, T.languages[n], n)),
                i && c.close()
            },
            !1)),
            T;
        var e = document.currentScript || [].slice.call(document.getElementsByTagName("script")).pop();
        return e && (T.filename = e.src, T.manual || e.hasAttribute("data-manual") || ("loading" !== document.readyState ? window.requestAnimationFrame ? window.requestAnimationFrame(T.highlightAll) : window.setTimeout(T.highlightAll, 16) : document.addEventListener("DOMContentLoaded", T.highlightAll))),
            T
    ...
    void 0 !== t && (t.Prism = c),
        c.languages.markup = {
            ...
            cdata: /<!\[CDATA\[[\s\S]*?]]>/i,
            tag: {
                pattern: /<\/?(?!\d)[^\s>\/=$<%]+(?:\s(?:\s*[^\s>\/=]+(?:\s*=\s*(?:"[^"]*"|'[^']*'|[^\s'">=]+(?=[\s>]))|(?=[\s/ > ]))) + ) ? \s * \ / ?>/i,greedy:!0,inside:{tag:{pattern:/ ^ <\ / ?[ ^ \s > \ / ] + /i,inside:{punctuation:/ ^ <\ / ?/,namespace:/ ^ [ ^ \s > \ / :] + :/}},"attr-value":{pattern:/ = \s * ( ? :"[^"] * "|'[^']*'|[^\s'" >= ] + ) / i, inside: {
        punctuation: [/^=/, {
            pattern: /^(\s*)["']|["']$/,
            lookbehind: !0
        }]
    ...
    c.languages.markup.tag.inside["attr-value"].inside.entity = c.languages.markup.entity, c.hooks.add("wrap",
        function(e) {
        ...
        if (!e.hasAttribute("data-src-loaded")) {
            ...
            o.open("GET", n, !0),
                o.onreadystatechange = function() {
                    4 == o.readyState && (o.status < 400 && o.responseText ? (s.textContent = o.responseText, c.highlightElement(s), e.setAttribute("data-src-loaded", "")) : 400 <= o.status ? s.textContent = "✖ Error " + o.status + " while fetching file: " + o.statusText: s.textContent = "✖ Error: File does not exist or is empty")
                },
                o.send(null)
        }
    }),
    c.plugins.toolbar && c.plugins.toolbar.registerButton("download-file",
        function(e) {
...
function B(e) {
    ...
    var t = e.trim().replace(/[A-Z]+/g, Z).replace(/<[^>\d]+>/g, "").replace(I, "").replace(/\s/g, "-").replace(/-+/g, "-").replace(/^(\d)/, "_$1"),
        n = H[t];
    return n = l.call(H, t) ? n + 1 : 0,
    (H[t] = n) && (t = t + "-" + n),
        t
}
function D(e, t) {
...
var ee, te = o(function(e) {
    return e.replace("#", "?id=")
});
function ne(e, t) {
    return "___" + e.toUpperCase() + t + "___"
}
ee = Prism, Object.defineProperties(ee.languages["markup-templating"] = {},
    {
        buildPlaceholders: {
            value: function(r, i, e, a) {
                if (r.language === i) {
                    var s = r.tokenStack = [];
                    r.code = r.code.replace(e,
                        function(e) {
                            if ("function" == typeof a && !a(e)) return e;
                            for (var t, n = s.length; - 1 !== r.code.indexOf(t = ne(i, n));)++n;
                            return s[n] = e,
                                t
                        }),
                        r.grammar = ee.languages.markup
                }
            }
        },
        tokenizePlaceholders: {
            value: function(d, g) {
                if (d.language === g && d.tokenStack) {
                    d.grammar = ee.languages[g];
                    var f = 0,
                        m = Object.keys(d.tokenStack); !
                        function e(t) {
                            for (var n = 0; n < t.length && !(f >= m.length); n++) {
                                var r = t[n];
                                if ("string" == typeof r || r.content && "string" == typeof r.content) {
                                    ...
                                    if ( - 1 < l) {++f;
                                        var c = s.substring(0, l),
                                            u = new ee.Token(g, ee.tokenize(a, d.grammar), "language-" + g, a),
                                            h = s.substring(l + o.length),
                                            p = [];
                                        c && p.push.apply(p, e([c])),
                                            p.push(u),
                                        h && p.push.apply(p, e([h])),
                                            "string" == typeof r ? t.splice.apply(t, [n, 1].concat(p)) : r.content = p
                                    }
...
function ie(e) {
    ...
    var r = {};
    return {
        str: e = e && e.replace(/^'/, "").replace(/'$/, "").replace(/(?:^|\s):([\w-]+)=?([\w-]+)?/g,
            function(e, t, n) {
...
var ae = {
    ...
    se = function(i, e) {
        ...
        var s, t = this._initRenderer(),
            n = i.markdown || {};
        s = r(n) ? n(j, t) : (j.setOptions(d(n, {
            ...
            this.compile = function(n) {
                var r = !0,
                    e = o(function(e) {
                        r = !1;
                        var t = "";
                        return n ? (t = c(n) ? s(n) : s.parser(n), t = i.noEmoji ? t: function(e) {
                            return e.replace(/<(pre|template|code)[^>]*?>[\s\S]+?<\/(pre|template|code)>/g,
                                function(e) {
                                    return e.replace(/:/g, "__colon__")
                                }).replace(/:(\w+?):/gi, window.emojify || D).replace(/__colon__/g, ":")
                        } (t), B.clear(), t) : n
                    })(n),
    ...
    };se.prototype.compileEmbed = function(e, t) {
    var n, r = ie(t),
        i = r.str,
        a = r.config;
    if (t = i, a.include) {
        var s;
        if (W(e) || (e = K(this.contentBase, X(this.router.getCurrentPath()), e)), a.type && (s = ae[a.type]))(n = s.call(this, e, t)).type = a.type;
        else {
            var o = "code";
            /\.(md|markdown)/.test(e) ? o = "markdown": /\.mmd/.test(e) ? o = "mermaid": /\.html?/.test(e) ? o = "iframe": /\.(mp4|ogg)/.test(e) ? o = "video": /\.mp3/.test(e) && (o = "audio"),
                (n = ae[o].call(this, e, t)).type = o
        }
        return n.fragment = a.fragment,
            n
    }
},
    se.prototype._matchNotCompileLink = function(e) {
        for (var t = this.config.noCompileLinks || [], n = 0; n < t.length; n++) {
            var r = t[n];
            if ((re[r] || (re[r] = new RegExp("^" + r + "$"))).test(e)) return e
        }
    },
    se.prototype._initRenderer = function() {
        var e = new j.Renderer,
            o = this.linkTarget,
            l = this.linkRel,
            u = this.router,
            h = this.contentBase,
        ...
        return t.heading = e.heading = function(e, t) {
            ...
            /{docsify-ignore}/g.test(r) && (r = r.replace("{docsify-ignore}", ""), a.title = r, a.ignoreSubHeading = !0),
            /{docsify-ignore-all}/g.test(r) && (r = r.replace("{docsify-ignore-all}", ""), a.title = r, a.ignoreAllSubs = !0);
            var s = B(i.id || r),
                o = u.toURL(u.getCurrentPath(), {
                    id: s
                });
            return a.slug = o,
                c.toc.push(a),
            "<h" + t + ' id="' + s + '"><a href="' + o + '" data-id="' + s + '" class="anchor"><span>' + r + "</span></a></h" + t + ">"
        },
            t.code = e.code = function(e, t) {
                return void 0 === t && (t = ""),
                    e = e.replace(/@DOCSIFY_QM@/g, "`"),
                '<pre v-pre data-lang="' + t + '"><code class="lang-' + t + '">' + M.highlight(e, M.languages[t] || M.languages.markup) + "</code></pre>"
            },
            t.link = e.link = function(e, t, n) {
                ...
                var r = "",
                    ...
                    s = i.config;
                return t = a,
                    W(e) || c._matchNotCompileLink(e) || s.ignore ? (r += 0 === e.indexOf("mailto:") ? "": ' target="' + o + '"', r += 0 === e.indexOf("mailto:") ? "": "" !== l ? ' rel="' + l + '"': "") : (e === c.config.homepage && (e = "README"), e = u.toURL(e, null, u.getCurrentPath())),
                s.target && (r += " target=" + s.target),
                s.disabled && (r += " disabled", e = "javascript:void(0)"),
                t && (r += ' title="' + t + '"'),
                '<a href="' + e + '"' + r + ">" + n + "</a>"
            },
            t.paragraph = e.paragraph = function(e) {
                return /^!&gt;/.test(e) ? F("tip", e) : /^\?&gt;/.test(e) ? F("warn", e) : "<p>" + e + "</p>"
            },
            t.image = e.image = function(e, t, n) {
                ...
                return W(e) || (r = K(h, X(u.getCurrentPath()), e)),
    ...
    se.prototype.sidebar = function(e, t) {
        var n = this.toc,
        ...
        if (e) i = this.compile(e);
            ...
            for (var a = 0; a < n.length; a++) if (n[a].ignoreSubHeading) {
                var s = n[a].level;
                n.splice(a, 1);
                for (var o = a; s < n[o].level && o < n.length; o++) n.splice(o, 1) && o--&&a++;
                a--
            }
            var l = this.cacheTree[r] || q(n, t);
            i = E(l, "<ul>{inner}</ul>"),
                this.cacheTree[r] = l
        }
        return i
    },
    se.prototype.subSidebar = function(e) {
        if (e) {
    ...
    se.prototype.article = function(e) {
        return this.compile(e)
    },
    se.prototype.cover = function(e) {
...
function le() {
    ...
    if (e) {
        ...
        window.pageYOffset >= t || e.classList.contains("hidden") ? A(v, "add", "sticky") : A(v, "remove", "sticky")
    }
}
function ce(e, t, r, n) {
    var i = [];
    null != (t = m(t)) && (i = k(t, "a"));
    var a, s = decodeURI(e.toURL(e.getCurrentPath()));
    return i.sort(function(e, t) {
        return t.href.length - e.href.length
    }).forEach(function(e) {
        var t = e.getAttribute("href"),
            n = r ? e.parentNode: e;
        0 !== s.indexOf(t) || a ? A(n, "remove", "active") : (a = e, A(n, "add", "active"))
    }),
    n && (f.title = a ? a.title || a.innerText + " - " + oe: oe),
        a
}
function ue(e, t) {
    ...
    },
    {
        ...
        value: function(e) {
            ...
            this.timeStart || (this.timeStart = e),
                ...
                this._shouldTick(t) ? (this._emit("tick", this.tweener.getIntermediateValue(this.next)), this.frame = window.requestAnimationFrame(this._tick.bind(this))) : (this._emit("tick", this.tweener.getFinalValue()), this._emit("done", null))
        }
    },
    {
        key: "_shouldTick",
...
function fe() {
    var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {}; !
        ...
        this.tweener = e.tweener || new he(e),
...
function we(e) {
    if (ye) {
        for (var t, n = m(".sidebar"), r = k(".anchor"), i = y(n, ".sidebar-nav"), a = y(n, "li.active"), s = document.documentElement, o = (s && s.scrollTop || document.body.scrollTop) - ke, l = 0, c = r.length; l < c; l += 1) {
            var u = r[l];
            if (u.offsetTop > o) {
                t = t || u;
                break
        ...
        if (t) {
            var h = me[xe(decodeURIComponent(e), t.getAttribute("data-id"))];
            if (h && h !== a && (a && a.classList.remove("active"), h.classList.add("active"), a = h, !ve && v.classList.contains("sticky"))) {
                var p = n.clientHeight,
                    d = a.offsetTop + a.clientHeight + 40,
                    g = d - 0 < p,
                    f = a.offsetTop >= i.scrollTop && d <= i.scrollTop + p ? i.scrollTop: g ? 0 : d - p;
                n.scrollTop = f
            }
        }
    }
...
function _e(e, t) {
    if (t) {
        ...
        function(e) {
            be && be.stop(),
                ...
                be = new ge({
                    ...
                    end: e.getBoundingClientRect().top + window.pageYOffset,
                    duration: 500
                }).on("tick",
                    function(e) {
        ...
        var r = me[xe(e, t)],
            i = y(m(".sidebar"), "li.active");
        i && i.classList.remove("active"),
        r && r.classList.add("active")
    }
}
var Se = f.scrollingElement || f.documentElement;
var Ae = {};
function $e(e, i) {
    var s = e.compiler,
        a = e.raw;
    ...
    var o = s._marked,
        l = o.lexer(a),
        c = [],
        u = o.InlineLexer.rules.link,
        h = l.links;
    l.forEach(function(e, a) {
        "paragraph" === e.type && (e.text = e.text.replace(new RegExp(u.source, "g"),
            function(e, t, n, r) {
                var i = s.compileEmbed(n, r);
                return i && c.push({
                    index: a,
                    embed: i
                }),
        ...
        function(e, a) {
            ...
            for (; t = n[o++];) {
                var r = function(i) {
                    return function(e) {
                        var t;
                        if (e) if ("markdown" === i.embed.type) t = s.lexer(e);
                        else if ("code" === i.embed.type) {
                            if (i.embed.fragment) {
                                var n = i.embed.fragment,
                                    r = new RegExp("(?:###|\\/\\/\\/)\\s*\\[" + n + "\\]([\\s\\S]*)(?:###|\\/\\/\\/)\\s*\\[" + n + "\\]");
                                e = ((e.match(r) || [])[1] || "").trim()
                            }
                            t = s.lexer("```" + i.embed.lang + "\n" + e.replace(/`/g, "@DOCSIFY_QM@") + "\n```\n")
                        } else "mermaid" === i.embed.type ? (t = [{
                            type: "html",
                ...
                t.embed.url ? R(t.embed.url).then(r) : r(t.embed.html)
            }
        } ({
                compile: o,
                embedTokens: c,
            ...
            function(e) {
                ...
                if (n) {
                    ...
                    l.links = Ae[a].links = h,
                    i(l)
            })
}
function Ce() {
    var e = k(".markdown-section>script").filter(function(e) {
...
function Ee(e, t, n) {
    return t = "function" == typeof n ? n(t) : "string" == typeof n ?
        function(r, i) {
            var a = [],
                s = 0;
            return r.replace(P,
                function(t, e, n) {
                    a.push(r.substring(s, n - 1)),
                        s = n += t.length + 1,
                        a.push(i && i[t] ||
                            function(e) {
            ...
            s !== r.length && a.push(r.substring(s)),
                function(e) {
                    for (var t = "",
                             n = 0,
                             r = e || new Date; n < a.length; n++) t += "string" == typeof a[n] ? a[n] : a[n](r);
                    return t
                }
        } (n)(new Date(t)) : t,
...
function Fe(e) {
    ...
    this.config.loadSidebar || this._renderSidebar(),
        !1 === this.config.executeScript || void 0 === window.Vue || Ce() ? this.config.executeScript && Ce() : setTimeout(function(e) {
...
function Le(e) {
    ...
    if (i) {
        if (t.repo && (a +=
            ...
            } (t.repo, t.cornerExternalLinkTarge)), t.coverpage && (a +=
            function() {
                var e = ", 100%, 85%";
            ...
            var o = /^data:image/.test(t.logo),
                l = /(?:http[s]?:)?\/\//.test(t.logo),
                c = /^\./.test(t.logo);
            o || l || c || (t.logo = K(e.router.getBasePath(), t.logo))
        }
        a +=
            function(e) {
                var t = e.name ? u(e.name) : "",
                ...
                return (g ? n + "<main>": "<main>" + n) + '<section class="content"><article class="markdown-section" id="main">\x3c!--main--\x3e</article></section></main>'
            } (t),
            e._renderTo(i, a, !0)
    } else e.rendered = !0;
    t.mergeNavbar && g ? s = y(".sidebar") : (r.classList.add("app-nav"), t.repo || r.classList.add("no-badge")),
    t.loadNavbar && x(s, r),
    t.themeColor && (f.head.appendChild(w("div",
        function(e) {
        ...
        function(n) {
            if (! (window.CSS && window.CSS.supports && window.CSS.supports("(--v:red)"))) {
                var e = k("style:not(.inserted),link"); [].forEach.call(e,
                    function(e) {
                        if ("STYLE" === e.nodeName) O(e, n);
...
Re.prototype.getBasePath = function() {
    return this.config.basePath
},
    Re.prototype.getFile = function(e, t) {
        ...
        return e = (e = function(e, t) {
            ...
            function e(t, n, r) {
                var i = Object.keys(n).filter(function(e) {
                    return (Te[e] || (Te[e] = new RegExp("^" + e + "$"))).test(t) && t !== r
                })[0];
                return i ? e(t.replace(Te[i], n[i]), n, t) : t
            } (e, n.alias) : e, i)) === "/README" + i && n.homepage || e,
            e = W(e) ? e: K(r, e),
        t && (e = e.replace(new RegExp("^" + r), "")),
            e
    },
    Re.prototype.onchange = function(e) {
        void 0 === e && (e = h),
            e()
    },
    Re.prototype.getCurrentPath = function() {},
    Re.prototype.normalize = function() {},
    Re.prototype.parse = function() {},
    Re.prototype.toURL = function(e, t, n) {
        var r = n && "#" === e[0],
            i = this.parse(te(e));
        if (i.query = d({},
            i.query, t), e = (e = i.path + V(i.query)).replace(/\.md(\?)|\.md$/, "$1"), r) {
            var a = n.indexOf("?");
...
var Pe = function(r) {
    ...
    return r && (e.__proto__ = r),
        ...
        e.prototype.normalize = function() {
            ...
            if ("/" === (e = te(e)).charAt(0)) return Oe(e);
            Oe("/" + e)
        },
...
function Me(e) { !
    ...
    e.config.coverpage ? g || _("scroll", le) : v.classList.add("sticky")
}
function qe(t, n, r, i, a, e) {
    t = e ? t: t.replace(/\/$/, ""),
    (t = X(t)) && R(a.router.getFile(t + r) + n, !1, a.config.requestHeaders).then(i,
        function(e) {
            return qe(t, n, r, i, a)
        })
}
...
var Ze, Be, De, Ue = Ie.prototype;
function Ye(e, t, n) {
    return De && De.abort && De.abort(),
        De = R(e, !0, n)
}
Ue._init = function() {
    var e = this;
    e.config = function() {
        ...
        function(t) { [].concat(t.config.plugins).forEach(function(e) {
        ...
        function(t) {
            var e, n = t.config;
            e = "history" === (n.routerMode || "hash") && a ? new ze(n) : new Pe(n),
                t.router = e,
                je(t),
                Ne = t.route,
                e.onchange(function(e) {
                    je(t),
                        t._updateRender(),
                        Ne.path !== t.route.path ? (t.$fetch(), Ne = t.route) : t.$resetEvents()
                })
        } (e),
        Le(e),
        Me(e),
        function(t) {
            ...
            if (t.rendered) {
                var n = ce(t.router, ".sidebar-nav", !0, !0);
    ...
    Ze._bindEventOnRendered = function(e) {
        ...
        if (function(e) {
            ...
            for (var i = 0,
                ...
                if (o) {
                    ...
                    l && (me[decodeURIComponent(l)] = s)
                }
            }
            if (!g) {
                var p = e.getCurrentPath();
                S("scroll",
                    function() {
                        return we(p)
                    }),
        ...
        function(e) {
            void 0 === e && (e = 0),
                Se.scrollTop = !0 === e ? 0 : Number(e)
        } (r)
    },
    Ze._renderNav = function(e) {
        e && this._renderTo("nav", this.compiler.compile(e)),
        this.config.loadNavbar && ce(this.router, "nav")
    },
    Ze._renderMain = function(r, i, a) {
        var s = this;
        if (void 0 === i && (i = {}), !r) return Fe.call(this, r);
        p(this, "beforeEach", r,
            function(e) {
                function t() {
                    i.updatedAt && (n = Ee(n, i.updatedAt, s.config.formatUpdated)),
                        p(s, "afterEach", n,
                            function(e) {
                                return Fe.call(s, e)
                            })
                ...
                var n;
                s.isHTML ? (n = s.result = r, t(), a()) : $e({
                        compiler: s.compiler,
                        raw: e
                    },
                    function(e) {
                        n = s.compiler.compile(e),
                            t(),
                            a()
                    })
            })
    },
    Ze._renderCover = function(e, t) {
        var n = m(".cover");
        if (A(m("main"), t ? "add": "remove", "hidden"), e) {
            A(n, "add", "show");
            ...
            if (i) {
                if ("color" === i[2]) n.style.background = i[1] + (i[3] || "");
                    ...
                    var a = i[1];
                    A(n, "add", "has-mask"),
                    W(i[1]) || (a = K(this.router.getBasePath(), i[1])),
    ...
    (Be = Ue)._loadSideAndNav = function(e, t, n, r) {
        var i = this;
        return function() {
            if (!n) return r();
            qe(e, t, n,
    ...
    Be._fetchCover = function() {
        ...
        if (n) {
            var s = null,
                o = this.route.path;
            if ("string" == typeof n)"/" === o && (s = n);
            else if (Array.isArray(n)) s = -1 < n.indexOf(o) && "_coverpage";
            else {
                var l = n[o];
                s = !0 === l ? "_coverpage": l
            }
            var c = Boolean(s) && this.config.onlyCover;
            return s ? (s = this.router.getFile(a + s), this.coverIsHTML = /\.html$/g.test(s), R(s + V(i, ["id"]), !1, r).then(function(e) {
    ...
    Be._fetchFallbackPage = function(n, r, i) {
        var a = this;
        void 0 === i && (i = h);
        var e = this.config,
            t = e.requestHeaders,
            s = e.fallbackLanguages,
            o = e.loadSidebar;
        if (!s) return ! 1;
        var l = n.split("/")[1];
        if ( - 1 === s.indexOf(l)) return ! 1;
        var c = n.replace(new RegExp("^/" + l), "");
        return Ye(c + r, 0, t).then(function(e, t) {
                return a._renderMain(e, t, a._loadSideAndNav(n, r, o, i))
            },
            function() {
    ...
    Be._fetch404 = function(e, t, n) {
        ...
        if (o) {
            ...
            return Ye(this.router.getFile(c), 0, s).then(function(e, t) {
                    return r._renderMain(e, t, l)
                },
                function() {
                    return r._renderMain(null, {},
                        l)
                }),
                !0
        }
        return this._renderMain(null, {},
            l),
            !1
    },
    Ue.$resetEvents = function() {
        _e(this.route.path, this.route.query.id),
        this.config.loadNavbar && ce(this.router, "nav")
    },
    window.Docsify = {
        util: He,
    ...
    window.DocsifyCompiler = se, window.marked = j, window.Prism = M,
    function(e) {
